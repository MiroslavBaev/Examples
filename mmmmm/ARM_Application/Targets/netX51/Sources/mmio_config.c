...
*
*   NOTE:
*         The used configuration in this example is for a NXHX51-ETM
...
/**************************************************************************************
 function:    mmio_config_netx51
 description: Configured the MMIO pad with the Multiplexing Matrix unit inside netX51.
