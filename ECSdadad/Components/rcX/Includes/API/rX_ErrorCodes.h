...
*******************************************************************************
  ...
  Last Modification:
    @version $Id: rX_ErrorCodes.h 1389 2013-04-03 10:10:29Z MichaelT $
...
#ifndef __RX_ERRORCODES_H
#define __RX_ERRORCODES_H
  ...
  */
  ...
  enum  RX_RESULTtag {
    ...
    /* 0x70A */ RX_EVEGRP_OUT_OF_RESOURCES,
    ...
    /* 0x4C00 */ DRV_IO_NO_INIT            = 0x4C00,
    /* 0x4C01 */ DRV_IO_NAME,
    /* 0x4C02 */ DRV_IO_UNKNOWN,
    /* 0x4C03 */ DRV_IO_INVALID,
    /* 0x4C04 */ DRV_IO_NO_ACCESS,
    /* 0x4C05 */ DRV_IO_INVALID_IOCTRL,
    /* 0x4C06 */ DRV_IO_INVALID_BANK,
    /* 0x4C07 */ DRV_IO_INVALID_PARAMETER,
    ...
    /* 0x4F85 */ DRV_IIC_BUS_BUSY,
    /* 0x4F86 */ DRV_IIC_CMD_ERROR,
    ...
    /* 0x6400 */ MID_RTC_INIT_FAILED        = 0x6400,
    /* 0x6401 */ MID_RTC_READ_FAILED,
    /* 0x6402 */ MID_RTC_WRITE_FAILED,
    /* 0x6403 */ MID_RTC_TIME_INVALID,
  ...
  /*
  ***************************************************************
  *  Fatal Error Codes reported by RX or Tasks
  ***************************************************************
  */
  ...
  enum RX_FATALtag {
    ...
    /*  0 */ RX_FAT_BASE                 = 0x7000,

    /*   1 */ RX_FAT_RAM_TEST,                                          /* 0x7001 */
    /*   2 */ RX_FAT_EVENT_DOUBLE,                                      /* 0x7002 */
    /*   3 */ RX_FAT_EVENT_MISSING,                                     /* 0x7003 */
    /*   4 */ RX_FAT_IDLETASK_CREATION_FAILED,                          /* 0x7004 */
    /*   5 */ RX_FAT_MEMORY_BANK,                                       /* 0x7005 */
    /*   6 */ RX_FAT_SYSTEM_STATUS_TYPE,                                /* 0x7006 */
    /*   7 */ RX_FAT_TASK_CREATION,                                     /* 0x7007 */
    /*   8 */ RX_FAT_RX_MAILBOX,                                        /* 0x7008 */
    /*   9 */ RX_FAT_RX_KERNELTASK,                                     /* 0x7009 */
    /*  10 */ RX_FAT_RX_EVENTGROUP,                                     /* 0x700A */
    /*  11 */ RX_FAT_RX_SETEVENT,                                       /* 0x700B */
    /*  12 */ RX_FAT_RX_MULTIPLE,                                       /* 0x700C */
    /*  13 */ RX_FAT_CYCLIC_EVENT,                                      /* 0x700D */
    /*  14 */ RX_FAT_3964R_MAILBOX,                                     /* 0x700E */
    /*  15 */ RX_FAT_3964R_TIMER,                                       /* 0x700F */
    /*  16 */ RX_FAT_3964R_CREATE_EVENT,                                /* 0x7010 */
    /*  17 */ RX_FAT_3964R_WAIT_EVENT,                                  /* 0x7011 */
    /*  18 */ RX_FAT_3964R_CREATE_MAILBOX,                              /* 0x7012 */
    /*  19 */ RX_FAT_3964R_WAIT_MAILBOX,                                /* 0x7013 */
    /*  20 */ RX_FAT_SIZEOF_BARRIER,                                    /* 0x7014 */
    /*  21 */ RX_FAT_SIZEOF_MAILBOX,                                    /* 0x7015 */
    /*  22 */ RX_FAT_SIZEOF_MUTEX,                                      /* 0x7016 */
    /*  23 */ RX_FAT_SIZEOF_QUEUE,                                      /* 0x7017 */
    /*  24 */ RX_FAT_SIZEOF_SEMAPHORE,                                  /* 0x7018 */
    /*  25 */ RX_FAT_SIZEOF_SERIAL,                                     /* 0x7019 */
    /*  26 */ RX_FAT_SIZEOF_TIMER,                                      /* 0x701A */
    /*  27 */ RX_FAT_SIZEOF_CYCLIC,                                     /* 0x701B */
    /*  28 */ RX_FAT_SIZEOF_STATEMACHINE,                               /* 0x701C */
    /*  29 */ RX_FAT_INVALID_OBJECT,                                    /* 0x701D */
    /*  30 */ RX_FAT_PFLASH_CREATION,                                   /* 0x701E */
    /*  31 */ RX_FAT_UART_CREATION,                                     /* 0x701F */
    /*  32 */ RX_FAT_DPM_CREATION,                                      /* 0x7020 */
    /*  33 */ RX_FAT_TASK_MAX,                                          /* 0x7021 */
    /*  34 */ RX_FAT_MEMORYBLOCK_MAX,                                   /* 0x7022 */
    /*  35 */ RX_FAT_PFLASH_MAX,                                        /* 0x7023 */
    /*  36 */ RX_FAT_UART_MAX,                                          /* 0x7024 */
    /*  37 */ RX_FAT_DPM_MAX,                                           /* 0x7025 */
    /*  38 */ RX_FAT_DPM_CREATE_MAILBOX,                                /* 0x7026 */
    /*  39 */ RX_FAT_DPM_CREATE_EVENT,                                  /* 0x7027 */
    /*  40 */ RX_FAT_DPM_CREATE_HOOK,                                   /* 0x7028 */
    /*  41 */ RX_FAT_DPM_WAIT_MAILBOX,                                  /* 0x7029 */
    /*  42 */ RX_FAT_DPM_WAIT_EVENT,                                    /* 0x702A */
    /*  43 */ RX_FAT_DPM_TXMSG_EVENT,                                   /* 0x702B */
    /*  44 */ RX_FAT_DPM_TXMBX_FULL,                                    /* 0x702C */
    /*  45 */ RX_FAT_DPM_WAIT_SEGMENT,                                  /* 0x702D */
    /*  46 */ RX_FAT_DPM_MAILBOX_FLAG,                                  /* 0x702E */
    /*  47 */ RX_FAT_XC_CREATION,                                       /* 0x702F */
    /*  48 */ RX_FAT_XC_MAX,                                            /* 0x7030 */
    /*  49 */ RX_FAT_PHY_CREATION,                                      /* 0x7031 */
    /*  50 */ RX_FAT_PHY_MAX,                                           /* 0x7032 */
    /*  51 */ RX_FAT_TIME_EXCESSIVE,                                    /* 0x7033 */
    /*  52 */ RX_FAT_INT_CREATION,                                      /* 0x7034 */
    /*  53 */ RX_FAT_INT_MAX,                                           /* 0x7035 */
    /*  54 */ RX_FAT_TIM_CREATION,                                      /* 0x7036 */
    /*  55 */ RX_FAT_LED_CREATION,                                      /* 0x7037 */
    /*  56 */ RX_FAT_SIZEOF_CRC,                                        /* 0x7038 */
    /*  57 */ RX_FAT_INTERRUPT_ENABLED,                                 /* 0x7039 */
    /*  58 */ RX_FAT_OUTOF_TASKHEAP,                                    /* 0x703A */
    /*  59 */ RX_FAT_SCHEDULER_IRQ_ENABLED,                             /* 0x703B */
    /*  60 */ RX_FAT_SIZEOF_EVENTGROUP,                                 /* 0x703C */
    /*  61 */ RX_FAT_JUMPTABLESIZE_INSUFFICIENT,                        /* 0x703D */
    /*  62 */ RX_FAT_OUTOF_MEMORY,                                      /* 0x703E */
    /*  63 */ RX_FAT_SIZEOF_UART,                                       /* 0x703F */
    /*  64 */ RX_FAT_SIZEOF_HWTIMER,                                    /* 0x7040 */
    /*  65 */ RX_FAT_SIZEOF_INTERRUPT,                                  /* 0x7041 */
    /*  66 */ RX_FAT_TRACE_BUFFER,                                      /* 0x7042 */
    /*  67 */ RX_FAT_SPINLOCK_CORRUPT,                                  /* 0x7043 */
    /*  68 */ RX_FAT_SCHEDULER_INCONSISTENT,                            /* 0x7044 */
    /*  69 */ RX_FAT_MAILBOX_BUFFER,                                    /* 0x7045 */
    /*  70 */ RX_FAT_VOLUME_CREATION,                                   /* 0x7046 */
    /*  71 */ RX_FAT_SCHEDULER,                                         /* 0x7047 */
    /*  72 */ RX_FAT_EDD_CREATION,                                      /* 0x7048 */
    /*  73 */ RX_FAT_ICM_CREATION,                                      /* 0x7049 */
    /*  74 */ RX_FAT_SIZEOF_USB,                                        /* 0x704A */
    /*  75 */ RX_FAT_USB_CREATION,                                      /* 0x704B */
    /*  76 */ RX_FAT_SIZEOF_FIF,                                        /* 0x704C */
    /*  77 */ RX_FAT_SIZEOF_EBUS,                                       /* 0x704D */
    /*  78 */ RX_FAT_SIZEOF_MMU,                                        /* 0x704E */
    /*  79 */ RX_FAT_SIZEOF_TCM,                                        /* 0x704F */
    /*  80 */ RX_FAT_SIZEOF_CACHE,                                      /* 0x7050 */
    /*  81 */ RX_FAT_FIF_CREATION,                                      /* 0x7051 */
    /*  82 */ RX_FAT_EBUS_CREATION,                                     /* 0x7052 */
    /*  83 */ RX_FAT_MMU_CREATION,                                      /* 0x7053 */
    /*  84 */ RX_FAT_CCH_CREATION,                                      /* 0x7054 */
    /*  85 */ RX_FAT_WRONG_ROMKERNEL,                                   /* 0x7055 */
    /*  86 */ RX_FAT_TCM_CREATION,                                      /* 0x7056 */
    /*  87 */ RX_FAT_GPIO_CREATION,                                     /* 0x7057 */
    /*  88 */ RX_FAT_HIF_CREATION,                                      /* 0x7058 */
    /*  89 */ RX_FAT_PIO_CREATION,                                      /* 0x7059 */
    /*  90 */ RX_FAT_SPI_CREATION,                                      /* 0x705A */
    /*  91 */ RX_FAT_SFLASH_CREATION,                                   /* 0x705B */
    /*  92 */ RX_FAT_FIQ_CREATION,                                      /* 0x705C */
    /*  93 */ RX_FAT_SECPROM_NO_CHIP,                                   /* 0x705D */
    /*  94 */ RX_FAT_SECPROM_NOT_PERSONALIZED,                          /* 0x705E */
    /*  95 */ RX_FAT_SECPROM_NO_CONFIG,                                 /* 0x705F */
    /*  96 */ RX_FAT_SECPROM_INIT_FAILED,                               /* 0x7060 */
    /*  97 */ RX_FAT_HIFPIO_CREATION,                                   /* 0x7061 */
    /*  98 */ RX_FAT_HIF_DPM_INIT,                                      /* 0x7062 */
    /*  99 */ RX_FAT_MMU_INIT,                                          /* 0x7063 */
    /* 100 */ RX_FAT_NO_MEMORY_FOR_HANDLE_TABLE,                        /* 0x7064 */
    /* 101 */ RX_FAT_INVALID_HANDLE_TABLE_SIZE,                         /* 0x7065 */
    /* 102 */ RX_FAT_HANDLE_TABLE_FULL,                                 /* 0x7066 */
    /* 103 */ RX_FAT_MEM_LOCK_FAIL,                                     /* 0x7067 */
    /* 104 */ RX_FAT_SRAM_BUS_INVALID_CHIP_SELECT,                      /* 0x7068 */
    /* 105 */ RX_FAT_SRAM_BUS_INVALID_DATAWIDTH,                        /* 0x7069 */
    /* 106 */ RX_FAT_SRAM_BUS_INVALID_WAITSTATES,                       /* 0x706A */
    /* 107 */ RX_FAT_SRAM_BUS_INVALID_PRE_ACCESS_WAIT_STATES,           /* 0x706B */
    /* 108 */ RX_FAT_SRAM_BUS_INVALID_POST_ACCESS_WAIT_STATES,          /* 0x706C */
    /* 109 */ RX_FAT_SRAM_BUS_DUPLICATE_SRAM_CHIP_SELECT_CONFIGURATION, /* 0x706D */
    /* 110 */ RX_FAT_I2C_CREATION,                                      /* 0x706E */
    /* 111 */ RX_FAT_IO_CREATION,                                       /* 0x706F */

    /*  0 */ TASK_FAT_BASE  =   0x7200

  };
  typedef UINT32 RX_FATAL;
