...
*******************************************************************************
  ...
  Last Modification:
    @version $Id: TLR_CipProductCode.h 1664 2013-12-18 10:09:38Z AndreasB $
...
#ifndef __TLR_CIPPRODUCTCODE_H
#define __TLR_CIPPRODUCTCODE_H
