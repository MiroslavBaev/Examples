...
*******************************************************************************
  ...
  Last Modification:
    @version $Id: PointerFifo_Struct.h 414 2010-06-24 06:05:41Z MichaelT $
...
{
  volatile unsigned long aulData[16];
  volatile unsigned long aulBorder[16];
  ...
  volatile unsigned long aulReserved[11];
  volatile unsigned long aulFillLevel[16];
