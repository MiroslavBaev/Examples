 ...
 *******************************************************************************
   ...
   Last Modification:
    ...
    @version $Id: EcsV4_Public.h 57166 2015-11-03 10:38:57Z jochen $
...
#define ECAT_CMD_LIMITATION_LIB_EXPIRED_IND                         0x00002CD0
#define ECAT_CMD_LIMITATION_LIB_EXPIRED_RES                         0x00002CD0
/* -----------------------------------------------------------------------------
 *  types
 * -----------------------------------------------------------------------------
 */
