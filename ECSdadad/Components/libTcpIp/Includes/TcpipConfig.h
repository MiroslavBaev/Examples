...
*******************************************************************************
  ...
  Last Modification:
    @version $Id: TcpipConfig.h 29109 2012-11-02 14:35:29Z AndreasB $
  ...
  ---------------------------------------------------------------------------
    2010-06-08  NC            Added debug option DEBUG_TCP_LED_LIVESIGN
 ...
 *
 *  MCAST_TABLE_SIZE        Number of entries multicast address table   64
...
#define MCAST_TABLE_SIZE                (64)    /* Number of entries multicast address table, must be multiple  */
                                                /* of 16                                                        */
